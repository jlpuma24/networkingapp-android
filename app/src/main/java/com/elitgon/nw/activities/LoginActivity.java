...
public class LoginActivity extends BaseActivity {
    ...
    protected void onCreate(@Nullable Bundle savedInstanceState) {
        ...
        textViewTermsAndConditions.setPaintFlags(textViewTermsAndConditions.getPaintFlags() | Paint.UNDERLINE_TEXT_FLAG);
            ...
            public void onAuthSuccess() {
                ...
                apiHelper.getRequest(NetworkingApplication.getInstance(), getString(R.string.linkedin_url), new ApiListener() {
                    ...
                    public void onApiSuccess(ApiResponse apiResponse) {
                        ...
                        mBus.post(new LoginRequest(emailAddress, firstName, lastName, pictureUrl, publicProfileUrl, id, company, companyTitle, location));
                    }
